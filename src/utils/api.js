...
export const serverValidation = {
  ...
  validateEmail: (email) => {
    ...
    const disposableDomains = [
      ...
      'mailinator.com', 'yopmail.com', 'sharklasers.com', 'grr.la'
    ];
  ...
  validateMessage: (message) => {
    ...
    const suspiciousPatterns = [
      /spam/i, /viagra/i, /casino/i, /loan/i, /free.*money/i,
      /click.*here/i, /buy.*now/i, /urgent/i, /limited.*time/i
    ];
  ...
  validateService: (service) => {
    const validServices = [
      'event-planning', 'roadshow', 'brand-activation', 
      'promotional', 'other'
    ];
...
export const getPortfolioItems = (category) => apiService.getPortfolioItems(category);
export const getBlogPosts = (page, limit) => apiService.getBlogPosts(page, limit);
...
export const subscribeNewsletter = (email) => apiService.subscribeNewsletter(email);
...
export const trackEvent = (eventName, eventData) => apiService.trackEvent(eventName, eventData);
