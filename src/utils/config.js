...
const config = {
  ...
  // Social Media URLs
  social: {
    facebook: process.env.REACT_APP_FACEBOOK_URL || 'https://www.facebook.com/inadpromotion',
    twitter: process.env.REACT_APP_TWITTER_URL || 'https://www.twitter.com/inadpromotion',
    linkedin: process.env.REACT_APP_LINKEDIN_URL || 'https://www.linkedin.com/company/inadpromotion',
    instagram: process.env.REACT_APP_INSTAGRAM_URL || 'https://www.instagram.com/inadpromotion',
    youtube: process.env.REACT_APP_YOUTUBE_URL || 'https://www.youtube.com/channel/inadpromotion',
  },
  ...
  business: {
    ...
    address: process.env.REACT_APP_COMPANY_ADDRESS || '123 Business St, City, State 12345',
  },
  ...
  features: {
    ...
    imageOptimization: process.env.REACT_APP_ENABLE_IMAGE_OPTIMIZATION === 'true',
    videoOptimization: process.env.REACT_APP_ENABLE_VIDEO_OPTIMIZATION === 'true',
  },
