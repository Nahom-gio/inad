...
import { FaChevronDown, FaPlay, FaPause, FaVolumeMute, FaVolumeUp } from 'react-icons/fa';
      ...
      ([entry]) => {
        ...
        if (entry.isIntersecting && !isVideoLoaded) {
          ...
          if (video) {
            ...
            video.setAttribute('aria-label', 'Background video showing INAD PROMOTION events and activities');
      ...
      <div className="absolute inset-0 w-full h-full" role="presentation">
        ...
        >
            ...
            <p className="sr-only">
              ...
              This video shows various INAD PROMOTION events and activities.
            </p>
          </video>
