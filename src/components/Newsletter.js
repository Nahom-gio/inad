...
const Newsletter = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Success
      setIsSubmitted(true);
      setAnnouncement('Successfully subscribed to newsletter! Check your email for confirmation.');
    ...
    >
      ...
      <div className="container-custom">
        ...
        >
          ...
          >
            Get the latest insights, industry trends, and exclusive offers delivered 
            straight to your inbox. Join our community of marketing professionals.
          </p>
            ...
            >
              <div className="relative flex-1">
                <div className="relative">
                  <FaEnvelope className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 text-lg" aria-hidden="true" />
                  <input
                    ref={emailInputRef}
                    type="email"
                    value={email}
