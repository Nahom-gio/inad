                ...
                >
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between p-3 bg-dark-700/30 rounded-lg">
                      <div>
                        <h3 className="text-white font-medium text-sm">Necessary Cookies</h3>
                      ...
                      <div className="flex items-center">
                        ...
                        />
                        <span className="ml-2 text-xs text-gray-400">Always</span>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between p-3 bg-dark-700/30 rounded-lg">
                      <div>
                        ...
                        <p className="text-gray-400 text-xs">Used to deliver personalized advertisements</p>
                      </div>
                      <input
                        type="checkbox"
                    ...
                    <div className="flex items-center justify-between p-3 bg-dark-700/30 rounded-lg">
                      <div>
                        <h3 className="text-white font-medium text-sm">Preference Cookies</h3>
