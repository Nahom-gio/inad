...
import { FaEnvelope, FaWhatsapp, FaPhone, FaLinkedin, FaExclamationTriangle, FaCheckCircle } from 'react-icons/fa';
import { 
  checkRateLimit, 
  validateHoneypot, 
...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!checkRateLimit()) {
      ...
      setAnnouncement('Rate limit exceeded. Please wait before submitting again.');
      return;
    }
    ...
    if (detectSuspiciousPatterns(formData)) {
      setSubmitError('Suspicious content detected. Please review your message.');
      setAnnouncement('Suspicious content detected. Please review your message.');
      return;
    }
    ...
    try {
      ...
      if (result.success) {
        ...
        if (result.errors) {
          ...
          setAnnouncement('Form submission failed. Please correct the errors and try again.');
        } else {
      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16">
                  ...
                  <div>
                    ...
                    {errors.name && (
                      <motion.div
                        ...
                        aria-live="polite"
                      >
                        <FaExclamationTriangle className="mr-2 flex-shrink-0" aria-hidden="true" />
                        {errors.name}
                      </motion.div>
                    )}
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                  ...
                  <div>
                    <label htmlFor="service" className="block text-white font-medium mb-2 text-sm sm:text-base">
                      Service Interest <span className="text-red-400" aria-label="required">*</span>
                    </label>
                    <select
                      id="service"
                      name="service"
          ...
          >
            ...
            <div className="space-y-4 sm:space-y-6" role="list" aria-label="Contact methods">
              {contactMethods.map((method, index) => (
                ...
                >
                  <div className="text-primary-400 mr-3 sm:mr-4 group-hover:text-primary-300 transition-colors duration-300" aria-hidden="true">
                    {method.icon}
                  </div>
                  <div>
            ...
            <div className="mt-8 sm:mt-12 p-4 sm:p-6 bg-dark-700/30 rounded-2xl border border-dark-600/20">
              ...
              <div className="text-gray-300 space-y-1 text-sm sm:text-base" role="list" aria-label="Office hours">
