          ...
          >
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              <p>
                ...
                and big dreams, working tirelessly to transform how companies connect with their audiences.
              </p>
              <p>
                Today, we're proud to have delivered over 500 successful events and campaigns, 
                each one crafted with the same passion and attention to detail that we had on day one.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              <p>
                ...
                tells your brand story in a way that resonates deeply with your audience.
              </p>
              <p>
                From concept to execution, we're with you every step of the way, turning your vision 
                into reality with precision, creativity, and unwavering commitment to excellence.
              </p>
            </div>
          </motion.div>
        </div>
