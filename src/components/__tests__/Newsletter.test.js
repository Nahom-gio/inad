...
describe('Newsletter Component', () => {
  ...
  test('renders email input field', () => {
    ...
    const emailInput = screen.getByRole('textbox', { name: /email address for newsletter subscription/i });
  ...
  test('handles successful subscription', async () => {
    ...
    // Form should reset
    await waitFor(() => {
      expect(screen.queryByText(/Welcome to the Family!/i)).not.toBeInTheDocument();
  ...
  test('shows help text for email field', () => {
    ...
    expect(screen.getByText(/We'll never share your email with anyone else/i)).toBeInTheDocument();
  });
