...
describe('Hero Component', () => {
  ...
  describe('Rendering', () => {
    ...
    test('renders hero subtitle', () => {
      ...
      const subtitle = screen.getByText(/Transform your brand with immersive experiential marketing/i);
    ...
    test('renders call-to-action buttons', () => {
      ...
      const ctaButton = screen.getByRole('button', { name: /start your project/i });
      const portfolioButton = screen.getByRole('button', { name: /view our work/i });
  ...
  describe('Scroll Functionality', () => {
    test('scroll button is accessible', () => {
      ...
      const scrollButton = screen.getByLabelText(/scroll down to learn more about INAD PROMOTION/i);
