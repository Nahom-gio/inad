...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: <FaFacebook className="text-lg sm:text-xl" />, href: "#", label: "Facebook" },
    { icon: <FaInstagram className="text-lg sm:text-xl" />, href: "#", label: "Instagram" },
    { icon: <FaLinkedin className="text-lg sm:text-xl" />, href: "#", label: "LinkedIn" },
    { icon: <FaTwitter className="text-lg sm:text-xl" />, href: "#", label: "Twitter" }
  ];
